...
they cause, but whether it does so depends on how the insurance is
priced.

A uniform per-tank premium sets the marginal cost of operating an
additional aging, high-risk tank to zero, which removes the financial
incentive to retire it.

Underground petroleum storage tanks are a dominant source of groundwater
contamination in the United States, the harm is costly, and the
regulatory system, not private tort law, is the operative instrument for
controlling it.

Federal law requires every operator to carry financial responsibility
coverage, but it is silent on pricing, and 38 states met the mandate
with uniform per-tank premiums that price no risk.

On December 22, 1998 the Texas Petroleum Storage Tank Fund closed
because it was insolvent, and about 26,000 facilities moved to
risk-rated private insurance at once.

Risk-based pricing raises the annual tank closure rate by 1.58
percentage points (s.e. 0.40) on a pre-reform control mean of about 2
percent, and the response concentrates among old single-walled tanks.

The difference-in-differences design identifies the average effect of
the reform, but dollar welfare, counterfactual policies, and the
uninternalized health externality lie beyond its reach.

This paper contributes to the literatures on environmental liability and
financial responsibility, on hazardous capital under financial-assurance
rules, and on the welfare analysis of insurance markets.

The paper proceeds as follows: setting (§2), data (§3), reduced-form
evidence (§4), the structural model (§5), counterfactual welfare (§6),
and conclusion (§7).
...
risky tanks: \[E(n',e)=P(n',e)+H(n')\,D_e.\] \(P(n',e)\) is the
insurance premium the facility pays on the fleet \(n'\) under its
contract \(e\). \(H(n')\) is the facility's hazard, the chance that any
of its tanks leaks in the year. \(D_e\) is the deductible the facility
pays out of pocket when a leak occurs, so the second term is the
expected out-of-pocket cost of a leak. Both pieces rise with older and
single-walled tanks. The hazard \(H\) comes from the facility-level
model in §4.1, the premium \(P\) from the reconstructed schedule in
§4.2, and the deductible \(D_e\) from the contract terms. All three are
first-stage inputs, estimated outside the dynamic model and held fixed.
...
\[u_{\text{exit}}(s)=\kappa_1\,N(s).\] \(N(s)\) is the number of tanks
the facility holds. \(\kappa_1\) measures how exit value scales with
size. I normalize the constant part of exit value to zero, which pins
the level of the value function, so \(\kappa_1\) measures only how exit
value grows with the number of tanks.
...
\vspace{6pt}
\input{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Tables/T_Baseline_Characteristics_Slide.tex}
\par\vspace{10pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Figure_CV_CellRisk.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/FigureA_CV_Lift_State.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Figure_CV_Calibration.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Figure_CV_CellRisk_GoF.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/AE_X3_Premium_by_Age.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Figure_Actuarial_Alignment.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/04e_Premium_by_Year_Treatment.png}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Fig_CrossSub_Paid_Panel.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Fig_CrossSub_Area_Panel.pdf}
\par\vspace{8pt}
...
\par\vspace{8pt}
\includegraphics[width=0.85\textwidth,height=0.58\textheight,keepaspectratio]{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Figures/Fig_CrossSub_AreaTime_TN.pdf}
\par\vspace{8pt}
...
\vspace{6pt}
\input{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Tables/T_Stepped_DiD_OLS.tex}
\par\vspace{10pt}
...
\vspace{6pt}
\input{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Tables/T_LUST_A_Total.tex}
\par\vspace{10pt}
...
\vspace{6pt}
\input{C:/Users/kaleb/Documents/ust_ins_move_to_github/Output/Tables/T_LUST_B_Decomp.tex}
\par\vspace{10pt}
