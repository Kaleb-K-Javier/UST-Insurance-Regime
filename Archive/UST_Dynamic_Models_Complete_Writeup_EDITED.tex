...
\includegraphics{UST_Dynamic_Models_Complete_Writeup_EDITED_files/figure-pdf/fig-toy-benefit-1.pdf}
...
\midrule
Flat-Fee Pooling & 10 years\\
Self-Insurance & 1 years\\
Risk-Rated Private & 1 years\\
...
the net benefit of upgrading at each age. Risk-rated insurance (green)
creates the largest benefits at younger ages, inducing retrofit at 1
years. Self-insurance (blue) yields intermediate timing at 1 years.
Flat-fee pooling (red) delays retrofit until 10 years due to minimal
private internalization. The social optimum (purple) occurs even earlier
at 1 years, reflecting external damages not captured by private
contracts.
